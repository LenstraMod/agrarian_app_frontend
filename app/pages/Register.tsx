...
export default function Register(){
    ...
    return(
       <View style={styles.container}>
            ...
            <Text style={styles.subtitle}>Sudah punya akun ya? <Link style={{color: '#6AC595'}} href="./Login">Masuk Sini</Link></Text>
            
             <View style={styles.inputWrapper}>
                <Feather name='user' size={20} color='#999999' style={{marginRight: 8}} />
                <TextInput 
                    style={styles.input}
